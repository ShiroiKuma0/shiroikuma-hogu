---
name: build-apk
description: Build the signed release APK with the buildRelease Gradle task, then always ask whether to push it to the connected phone via adb. Always build first without asking for permission to build — the ONLY question you ever ask is the adb-push question afterward. Use whenever the user asks to build the app, build the APK, make a release build, or build and push to the phone for the 白い熊 防具 / shiroikuma-hogu Aegis fork.
---
